<%-- 
    Document   : addnews
    Created on : Feb 16, 2017, 4:35:05 PM
    Author     : brass
--%>
...
<html>
    ...
    <body onload="Success()">
        ...
        <h2 align="center">เพิ่มข้อมูลข่าว</h2>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="row">
                    <div class="box box-info">
                        <form class="form-horizontal" name="insertform" action="NewsbuataiAction.do" method="post"  enctype="multipart/form-data">

                            <div class="box-body">
                                <input type="hidden" name="todo" value="insertnews">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 inputGroupContainer">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-tags"></i></span>
                                            <input  name="name_N" placeholder="กรุณากรอกชื่อข่าว" class="form-control"  type="text" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input  name="file_N" class="form-control"  type="file" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input  name="time_N" placeholder="วันที่ลงข่าว" class="form-control"  type="date"  required="">
                                        </div>
                                    </div>
                                </div>
